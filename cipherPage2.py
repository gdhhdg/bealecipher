#sample running the page 2 cipher with the Declaration of Independence as the key.
#Please note that the author made several numbering errors, so the output isn't fully readable without some guesswork.
#However, It renders far more results than with a different key.
#Fill free to contribute smarter regexes to sort partial words, different vowels, and other word patterns.
...
output = []
searchWords = ['gold', 'bedford', 'county', 'pot', 'rock', 'dirt', 'buford','bluford','vault', 'miles','north','south','east','west','road','dig','put','and','the','im','if','bury','buried','pound','stone','silver','with','it','in','on','to','for','at','or','will','number','state', 'horse', 'dug','you','go','stop','end','pull','end','start','below','low','part','teen','hundred','thousand','thou','sand','dollar','find']
